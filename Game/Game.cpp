...
Game::Game(ID3D11Device* _pd3dDevice, HWND _hWnd, HINSTANCE _hInstance) 
{
	...
	pPlayer->SetPos(Vector3(50.0f, 50.0f, 50.0f));
	m_GameObjects.push_back(pPlayer);

	//add a secondary camera
	m_TPScam = new TPSCamera(0.25f * XM_PI, AR, 1.0f, 10000.0f, pPlayer, Vector3::UnitY, Vector3(0.0f, 0.1f, 0.1f));
	...
	//Add Terrain object
	VBTerrain* vbTerr = new VBTerrain();
	vbTerr->init(_pd3dDevice);
	//vbTerr->SetPos(Vector3(0.0f, 0.0f, 0.0f));
	vbTerr->SetScale(0.6f, 0.1f, 0.6f);
	m_GameObjects.push_back(vbTerr);
};
